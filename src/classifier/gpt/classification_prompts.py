...
Is de actor voor meer {L_description}, of juist voor meer {R_description}? Als de actor juist tegen {L_description} is, kies dan {R_description} en andersom.
...
Links Label: {L_label}
Bescrhijving: {L_description}


Rechts Label: {R_label}
Beschrijving: {R_description}

Geen/Ander/Neutraal Label: N

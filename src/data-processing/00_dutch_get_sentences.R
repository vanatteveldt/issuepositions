# Creates the units to be annotated: sentences that contain a political actor, plus the previous and next sentence
# Input: Article texts from AmCAT
# Output: data/intermediate/units_tk2023.csv
...
partijen <- readr::read_csv('https://docs.google.com/spreadsheet/ccc?key=1d3G1_y_HJP2Ik1v7rKrxeAXL4uCt5mLNgc8uC7vzQyI&output=csv')
